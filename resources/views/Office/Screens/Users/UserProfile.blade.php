...
<div class="content-body">
    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            <li><h5 class="bc-title">{{$user->name . "'s Profile"}}</h5></li>
        </ol>
    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive active-projects style-1" style="padding: 30px">
                            <div class="tbl-caption">
                                ...
                                <div>
                                    <a class="btn btn-danger btn-sm" href="{{ URL::to('office/users') }}" role="button">All Users</a>
                                </div>
                            </div>
                            <div class="text-center">
                                <img src="{{ asset('uploads/' . $user->profile_pic) }}" style="height: 100px;width: 100px;border-radius:50px">
                            </div>
                            <table class="table">
                                <tr>
                                    <th>Name</th>
                            ...
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="{{ URL::to('office/user/profile/' . $from->id) }}">
                                            <img src="{{ asset('uploads/' . $from->profile_pic) }}" style="height: 50px; width:50px;border-radius:25px">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>
                                        <a href="{{ URL::to('office/user/profile/' . $ref->id) }}">
                                            <img src="{{ asset('uploads/' . $ref->profile_pic) }}" style="height: 50px; width:50px;border-radius:25px">
                                    ...
                                    <div style="background: #F4F4F4;border-radius: 10px;">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>{{ $active_package->package->name }}<br>{{ $active_package->package->type == 1 ? ($active_package->total_invested / $active_package->price_per_kg) : $active_package->package->meat_kgs }} KGs</td>
                                            </tr>
                                            <tr>
                                                <th>Price Per KG</th>
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td><strong>PKR {{ $transaction->inout ? '+' : '-' }}{{ $transaction->amount }}</strong></td>
